<?php
/**
 * Security tab: Turnstile analytics and the optional debug log.
 *
 * @package Helo
...
<div class="helo-card">
	<div class="helo-card__head">
		...
		<p><?php esc_html_e( 'Per-verification record including the visitor IP and page URL. Turned on in Settings; off by default because it stores identifying data.', 'helo-smtp' ); ?></p>
	</div>

	<?php if ( ! Helo_Settings::get( 'turnstile_debug_log' ) ) : ?>
		<p class="helo-hint"><?php esc_html_e( 'The debug log is disabled. Enable “Turnstile debug log” on the Settings tab to start recording entries.', 'helo-smtp' ); ?></p>
